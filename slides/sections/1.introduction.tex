...
\begin{columns}
	...
	\begin{column}{0.6\textwidth}
		...
		\textbf{Input}
		\begin{itemize}
			\item Chuỗi cử chỉ khởi tạo: $\mathbf{g} \in \mathbb{R}^{N \times D}$
			\item Chuỗi âm thanh: $\mathbf{a}_{\text{raw}}^{length}$ sample rate 16000 trong 4s: $\mathbf{a} \in \mathbb{R}^{6400}$
...
\begin{frame}{Khung chương trình}
		\begin{figure}[h]
			\centering
			\includegraphics[width=\textwidth]{MotionCapture}
		\end{figure}
