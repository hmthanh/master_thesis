...
\begin{itemize}
	\item Dựa trên tập dữ liệu có sẵn, chúng tôi chuyển giọng nói của dữ liệu thành văn bản, và dùng văn bản đó để làm dữ liệu huấn luyện mới.
...
%	với thông tin thời gian cho việc sinh cử chỉ kèm theo lời nói dựa trên giọng nói. Nhờ mô hình diffusion, chúng tôi có thể kiểm soát một cách linh hoạt cử chỉ được sinh ra, ví dụ: chỉnh sửa phong cách của cử chỉ, thiết lập cử chỉ khởi tạo, và sinh cử chỉ đa dạng.
